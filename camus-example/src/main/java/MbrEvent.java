...
public class MbrEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MbrEvent\",\"doc\":\"LivePErson event\",\"fields\":[{\"name\":\"time\",\"type\":\"string\"},{\"name\":\"rawRequest\",\"type\":\"string\"}]}");
  ...
  public static MbrEvent.Builder newBuilder() {
    return new MbrEvent.Builder();
  }
  
  /** Creates a new MbrEvent RecordBuilder by copying an existing Builder */
  public static MbrEvent.Builder newBuilder(MbrEvent.Builder other) {
    return new MbrEvent.Builder(other);
  }
  
  /** Creates a new MbrEvent RecordBuilder by copying an existing MbrEvent instance */
  public static MbrEvent.Builder newBuilder(MbrEvent other) {
    return new MbrEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MbrEvent>
    ...
    private Builder() {
      super(MbrEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(MbrEvent.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing MbrEvent instance */
    private Builder(MbrEvent other) {
            super(MbrEvent.SCHEMA$);
    ...
    /** Sets the value of the 'time' field */
    public MbrEvent.Builder setTime(java.lang.CharSequence value) {
    ...
    public MbrEvent.Builder clearTime() {
      time = null;
    ...
    /** Sets the value of the 'rawRequest' field */
    public MbrEvent.Builder setRawRequest(java.lang.CharSequence value) {
    ...
    public MbrEvent.Builder clearRawRequest() {
      rawRequest = null;
